word_set = [
    ...
    "PRODUCTIVITY", "PERFORMANCE", "EFFICIENCY", "TASK", "ASSIGNMENT", "RESPONSIBILITY", "LEADERSHIP", "STRATEGY", "PLANNING",
    ...
    "ENGINEERING", "CODING", "PROGRAMMING", "SOFTWARE", "HARDWARE", "TECHNICAL", "TOOLS", "EQUIPMENT", "PRINTER",
    "SCANNER", "NOTEBOOK", "DESK", "CHAIR", "CUBICLE", "CONFERENCE", "REMOTE", "HYBRID", "ONBOARDING", "OFFBOARDING",
    "HUMAN", "RESOURCES", "RECRUITMENT", "HIRING", "FIRING", "DISCIPLINE", "FEEDBACK", "APPRAISAL", "REVIEW",
    ...
    "ESCALATION", "SUPERVISION", "DELEGATION", "INITIATIVE", "OWNERSHIP", "PRIORITY", "MILESTONE", "TIMELINE", "WORKFLOW",
    "TEMPLATE", "FORM", "DOCUMENT", "MEMO", "NOTICE", "BULLETIN", "ANNOUNCEMENT", "NEWSLETTER", "MANUAL", "PROCEDURE",
    "GUIDELINES", "ETHICS", "INTEGRITY", "TRANSPARENCY", "ACCOUNTABILITY", "RESPECT", "COMMITMENT", "INNOVATION",
